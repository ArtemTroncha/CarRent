  ...
  <!-- <div class="card card-body filter">
    <form class="form-inline" role="form"> -->
                        <div class="row">
                           <div class="col-3">
                        <div>
                            <label class="filter-col lab" style="margin-right:0;" for="pref-search">Brand</label>
                        ...
                        <div class="form-group">
                            <label class="filter-col lab" style="margin-right:0;" for="pref-search">Model</label>
                        ...
                        <div class="col-3">
                        <div class="form-group">
                            <label class="filter-col lab" style="margin-right:0;" for="pref-search">Version</label>
                           ...
                           <div class="col-3">
                        <div class="form-group">
                            <label class="filter-col lab" style="margin-right:0;" for="pref-perpage">Color</label>
                        ...
                        <div class="row">
                           <div class="col-3">
                              <label class="filter-col lab" style="margin-right:0;" for="pref-perpage">Availability</label>
                           ...
                           <div class="col-2"><!-- form group [search] -->
                        <div class="form-group">
                            <label class="filter-col lab" style="margin-right:0;" for="pref-orderby">Mileage</label>
                        ...
                        <div class="col-2">
                        <div class="form-group" >
                            <label class="filter-col lab" style="margin-right:0;" for="pref-orderby">Year</label>
                           ...
                           <div class="col-3">
                        <div class="form-group">
                            <label class="filter-col lab" style="margin-right:0;" for="pref-perpage">Condition</label>
                           ...
                           <div class="col-3">
                               <label class="filter-col lab" style="margin-right:0;" for="pref-perpage">Seat Count</label>
                                <input v-model="filterdata.filter" type="number"  min="1" max="50" step="1" class="form-control fill"  aria-label="Year">
                           </div>
                           <div class="col-3">
                              <label class="filter-col lab" style="margin-right:0;" for="pref-perpage">Fuel Type</label>
                              <select v-model="filterdata.filterCondition" id="pref-perpage" class="form-control fill">
                        ...
                        <div class="row sort">
                           <div class="col-4">
                                <label for="inputState"  class="form-label lab">Sort by</label>
                                 <select v-model="FuelType" id="inputState" class="form-select fill">
